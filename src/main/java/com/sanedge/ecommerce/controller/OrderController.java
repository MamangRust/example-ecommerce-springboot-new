...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderRelationResponse>> findByOrderId(@PathVariable Integer id) {
        return ResponseEntity.ok(orderQueryService.findOrderRelation(id));
    }
