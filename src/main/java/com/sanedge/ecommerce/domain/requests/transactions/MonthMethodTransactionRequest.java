package com.sanedge.ecommerce.domain.requests.transactions;
...
@Data
@Schema(description = "Request untuk mengambil statistik transaksi bulanan berdasarkan metode pembayaran")
