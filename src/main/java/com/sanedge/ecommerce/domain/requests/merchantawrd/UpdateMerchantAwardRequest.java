package com.sanedge.ecommerce.domain.requests.merchantawrd;
...
@Data
@Schema(description = "Request untuk memperbarui sertifikasi atau penghargaan merchant")
public class UpdateMerchantAwardRequest {

    @NotNull
    @Schema(description = "ID sertifikasi/penghargaan merchant yang akan diperbarui", example = "1")
    private Integer merchantCertificationId;
