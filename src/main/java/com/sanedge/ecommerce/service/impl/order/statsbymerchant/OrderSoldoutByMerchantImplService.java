...
import com.sanedge.ecommerce.repository.order.statsbymerchant.OrderSoldOutByMerchantRepository;
import com.sanedge.ecommerce.service.order.statsbymerchant.OrderSoldOutByMerchantService;
...
public class OrderSoldoutByMerchantImplService implements OrderSoldOutByMerchantService {
        ...
        public ApiResponse<List<OrderMonthlyResponse>> findMonthlyOrdersByMerchant(MonthOrderMerchantRequest req) {
                ...
                try {
                        List<OrderMonthly> rawData = orderSoldOutByMerchantRepository
        ...
        public ApiResponse<List<OrderYearlyResponse>> findYearlyOrdersByMerchant(YearOrderMerchantRequest req) {
                ...
                try {
                        List<OrderYearly> rawData = orderSoldOutByMerchantRepository
