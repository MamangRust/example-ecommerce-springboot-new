...
import com.sanedge.ecommerce.repository.user_role.UserRoleRepository;
...
public abstract class BaseIntegrationTest {
    ...
    protected Merchant ensureMerchant(User user) {
        return merchantQueryRepository.findMerchantByUserId(user.getUserId().intValue()).orElseGet(() -> {
